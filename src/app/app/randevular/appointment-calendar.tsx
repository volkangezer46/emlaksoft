  ...
  return (
    <section className="rounded-[20px] border border-line bg-surface p-5 shadow-[var(--shadow-xs)]">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="rounded-[8px] border border-line px-2.5 py-1 text-[10px] font-semibold text-text-muted transition hover:bg-canvas"
          >
            Bugün
          </button>
          <button
      ...
      <div className="mt-3 grid grid-cols-7 gap-px text-center">
        {TR_DAYS_SHORT.map((d) => (
          <div key={d} className="py-1.5 text-[10px] font-bold text-text-faint">{d}</div>
        ))}
      </div>
        ...
        <div className="mt-4 border-t border-line pt-4">
          ...
          {selectedAppts.length === 0 ? (
            ...
            <div className="space-y-1.5">
              {selectedAppts.map((a) => (
                <div key={a.id} className="flex items-center gap-2 rounded-[10px] border border-line bg-canvas/60 px-3 py-2">
