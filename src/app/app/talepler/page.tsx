        ...
        <div className="grid gap-3">
          {rows.map((d) => {
            ...
            return (
              <article
                key={d.id}
                className="rounded-[18px] border border-line bg-surface p-5 shadow-[var(--shadow-xs)] transition hover:border-brand-400/40"
              >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {customer ? (
                      <Link
                        ...
                        className="inline-flex items-center gap-1 rounded-[10px] border border-line px-3 py-2 text-xs font-semibold text-ink-950 hover:bg-canvas"
                      >
                        Müşteri <ArrowUpRight className="h-3.5 w-3.5" />
                      </Link>
                    ) : null}
                    <Link
