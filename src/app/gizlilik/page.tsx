  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-4 text-[var(--ink)]/70 leading-relaxed">
        Bu sayfa taslaktır. KVKK aydınlatma metni, işlenen veriler, saklama süreleri ve
        haklarınız (erişim, silme, itiraz) yasal inceleme sonrası burada yayınlanacaktır.
        Veriler Avrupa bölgesinde (Supabase eu-central-1) barındırılır.
      </p>
